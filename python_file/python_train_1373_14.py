...
#print(white.area, b1_olap.area, b2_olap.area, olap_olap.area, white.area - b1_olap.area - b2_olap.area + olap_olap.area)

if white.area - b1_olap.area - b2_olap.area + olap_olap.area > 0:
    print("YES")
else:
    print("NO")
