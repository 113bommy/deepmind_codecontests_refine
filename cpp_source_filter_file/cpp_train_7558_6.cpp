#include <bits/stdc++.h>
using namespace std;
int n, q, sex[201000], num[201000], tmp[201000];
struct R {
  int to, nex;
} r[201000];
int hea[201000] = {0}, cnt = 1;
int d[201000], bsz, bel[201000], used[23333], tim[201000];
long long tot[2][201000], ans, an[201000];
int fa[201000][20] = {0}, dft = 0, df1[201000], df2[201000], dep[201000] = {0};
