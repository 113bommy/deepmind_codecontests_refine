...
using namespace std;
const int MX = 200200;
int T, n, m, i, j, x, y, z, pos, cnt, le, ri, h, fi[MX], lst[MX], s[MX], t[MX],
    ch[MX], cht[MX], a[18][MX], npw[MX], L[MX], R[MX], A[MX];
priority_queue<long long, vector<long long>, greater<long long>> q;
pair<long long, long long> seg[MX * 44];
vector<int> g[MX], f[MX];
long long d[MX];
void dfs(int i, long long dep) {
  a[0][++T] = i;
  fi[i] = T;
  d[i] = dep;
