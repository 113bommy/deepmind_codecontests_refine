  ...
  for (int i = 1; i <= num; i++) {
    if (a[i].x != -1) {
      if (f[i - 1][0] != -1) {
        if (f[i][0] == -1 ||
            f[i][0] >
                f[i - 1][0] + dis(a[i].x, a[i].y, a1[i - 1].c, a1[i - 1].y))
          f[i][0] = f[i - 1][0] + dis(a[i].x, a[i].y, a1[i - 1].x, a1[i - 1].y);
      }
      if (f[i - 1][1] != -1) {
        if (f[i][0] == -1 ||
            f[i][0] > f[i - 1][1] + dis(a[i].x, a[i].c, a[i - 1].x, a[i - 1].c))
    ...
    if (a[i].y != -1) {
      if (f[i - 1][0] != -1) {
        if (f[i][1] == -1 ||
            f[i][1] >
                f[i - 1][0] + dis(a1[i].x, a1[i].y, a1[i - 1].c, a1[i - 1].y))
          f[i][1] =
      ...
      if (f[i - 1][1] != -1) {
        if (f[i][1] == -1 ||
            f[i][1] >
                f[i - 1][1] + dis(a1[i].x, a1[i].y, a[i - 1].x, a[i - 1].c))
