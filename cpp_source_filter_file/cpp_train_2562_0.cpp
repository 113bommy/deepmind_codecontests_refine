...
int main() {
  ...
  vector<long long> mini(n + 1, (long long)(1e10));
  long long sum = n * (long long)(1e10);
  long long count = 0;
  ...
  vector<long long> min1(n + 1, (long long)(1e10));
  long long sum1 = n * (long long)(1e10);
  long long count1 = 0;
  sort(v2.begin(), v2.end());
  reverse(v2.begin(), v2.end());
  long long ansss = (long long)(1e10);
      ...
      if (count1 == n) {
        auto it =
            upper_bound(ans2.begin(), ans2.end(),
                        make_pair(p.first.first - k - 1, (long long)(1e10)));
        if (it != ans2.begin()) {
          it--;
