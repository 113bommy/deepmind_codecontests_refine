...
int main() {
  ...
  if (strcmp(f, "wednesday") == 0 && strcmp(s, "wednesday") == 0 ||
      ...
      strcmp(f, "wednesday") == 0 && strcmp(s, "saterday") == 0) {
    cout << "YES" << endl;
    return 0;
  }
  if (strcmp(f, "thursday") == 0 && strcmp(s, "thursday") == 0 ||
      strcmp(f, "thursday") == 0 && strcmp(s, "saterday") == 0 ||
  ...
  if (strcmp(f, "saterday") == 0 && strcmp(s, "saterday") == 0 ||
      strcmp(f, "saterday") == 0 && strcmp(s, "monday") == 0 ||
      strcmp(f, "saterday") == 0 && strcmp(s, "tuesday") == 0) {
    cout << "YES" << endl;
    return 0;
  } else
    cout << "NO" << endl;
