...
int main() {
  ...
  long long s1 = abs(x5 * y6 + x6 * y7 + x7 * y8 + x8 * y5 - x8 * y7 - x7 * y6 -
                     x6 * y5 - x5 * y8);
  long long s2 = abs(x1 * y5 + x5 * y8 + x8 * y1 - x8 * y5 - x5 * y1 - x5 * y8);
  s2 += abs(x1 * y5 + x5 * y6 + x6 * y1 - x6 * y5 - x5 * y1 - x5 * y6);
  s2 += abs(x1 * y6 + x6 * y7 + x7 * y1 - x7 * y6 - x6 * y1 - x6 * y7);
  s2 += abs(x1 * y7 + x7 * y8 + x8 * y1 - x8 * y7 - x7 * y1 - x7 * y8);
  if (s1 == s2)
    cout << "YES";
  else
    cout << "NO";
