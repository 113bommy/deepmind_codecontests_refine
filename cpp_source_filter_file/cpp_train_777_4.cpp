...
void DFZ(int x) {
  ...
  double SDelta = 0;
  for (int e = lnk[x]; e; e = pre[e])
    Delta[tgt[e]] = 0, Get_dis(tgt[e], x, val[e], tgt[e]),
    SDelta += Delta[tgt[e]];
