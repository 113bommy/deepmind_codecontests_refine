...
pair<long long, long long> clock(long long a, long long b, long long n,
                                 long long m) {
  long long val = x % 4;
  if (val == 0)
...
pair<long long, long long> hor(long long a, long long b, long long n,
                               long long m) {
  if (y % 2 == 0)
    return pair<long long, long long>(a, b);
  else
...
pair<long long, long long> anticlock(long long a, long long b, long long n,
                                     long long m) {
  long long val = z % 4;
  if (val == 0)
    return pair<long long, long long>(a, b);
