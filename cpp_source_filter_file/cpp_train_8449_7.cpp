#include <bits/stdc++.h>
int h[510], nxt[25010], to[25010], cap[25010], K = 1;
int q[510], hh = 0, tt = 0, lvl[510], iter[510];
int bx[510], by[510];
...
int main() {
  ...
  std::sort(bx + 1, bx + totx + 1);
  totx = std::unique(bx + 1, bx + totx + 1) - bx - 1;
  std::sort(by + 1, by + toty + 1);
  toty = std::unique(by + 1, by + toty + 1) - by - 1;
