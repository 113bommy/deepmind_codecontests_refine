...
int main() {
  ...
  if (arr[6][1] != 0) a[5] = arr[6][1];
  if (arr[3][1] != 0 && arr[4][1] != 0) a[6] = arr[4][1] + arr[3][1];
  if (arr[4][1] != 0 && arr[5][1] != 0) a[7] = arr[4][1] + arr[5][1];
  if (arr[5][1] != 0 && arr[3][1] != 0) a[8] = arr[5][1] + arr[3][1];
  sort(a, a + 8);
  for (i = 0; i < 8; i++) {
    if (a[i] != 0) {
      c = a[i];
