...
dpoint intersect(line eq1, line eq2) {
  ...
  return dpoint((eq1.c * eq2.b - eq1.b * eq2.c) / det,
                (eq1.a * eq2.c - eq1.c * eq2.a) / det);
}
...
bool isGood(point p1, point p2, point p3, dpoint& dp1, dpoint& dp2, dpoint& dp3,
            dpoint& dp4) {
...
bool isGood2(point p1, point p2, point p3, dpoint& dp1, dpoint& dp2,
             dpoint& dp3, dpoint& dp4) {
  if ((p1.x == p2.x && p1.y == p2.y) || (p1.x == p3.x && p1.y == p3.y) ||
      (p2.x == p3.x && p2.y == p3.y)) {
    return false;
  }
