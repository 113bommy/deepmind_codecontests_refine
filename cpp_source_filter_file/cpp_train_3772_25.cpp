...
vector<long> x, y, Count(200000, 0), ans(200000, 0);
vector<pair<long, long> > str(200000, pair<long, long>(INF, 0)),
    sto(200000, pair<long, long>(INF, 0)), d1(200000, pair<long, long>(INF, 0)),
    d2(200000, pair<long, long>(INF, 0));
