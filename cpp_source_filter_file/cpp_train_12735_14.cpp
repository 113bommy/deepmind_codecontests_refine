#include <bits/stdc++.h>
using namespace std;
int par[100005][18], dep[100005], subtree[100005];
int chainhead[100005], chainid[100005], pos[100005], seg[4 * 100005];
vector<int> g[100005];
...
int query_chain(int u, int v) {
  ...
  if (u == v) return res;
  res += query(1, 1, ind - 1, pos[v], pos[u]);
  return res;
}
int main() {
  int n;
