...
int main() {
  ...
  if (n == 8) {
    ...
    printf("4 10 14 20 25 30 34\n");
    printf("5 12 17 25 31 36 43\n");
    printf("6 14 22 30 36 44 52\n");
    printf("7 16 25 34 43 52 61\n");
  }
  if (n == 9) {
    printf("1  2  3  4  5  6  7  8\n");
    printf("2  4  6  8 11 13 15 16\n");
    printf("3  6 10 13 16 20 23 24\n");
    printf("4  8 13 17 22 26 31 35\n");
    printf("5 11 16 22 27 33 37 44\n");
    printf("6 13 20 26 33 40 46 53\n");
    printf("7 15 23 31 37 46 54 60\n");
