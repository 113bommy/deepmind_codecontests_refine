#include <bits/stdc++.h>
using namespace std;
int n, x, y, dep[555555], DEP[555555], prem[555555], sufm[555555], iden,
    arr[555555], pa[555555], cnt, cur, tree[2222222];
int ans1[555555], ans2[555555], pre[555555], nxt[555555];
...
int main() {
  ...
  for (int i = 1; i <= n; i++) {
    ...
    for (int j = 1; j <= cnt; j++) {
      ...
      ans2[arr[j] - 1] = max(ans2[arr[j]], cur);
    }
    for (int j = 2; j <= cnt; j++) {
