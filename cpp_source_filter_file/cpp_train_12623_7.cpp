...
int n, Q, len, blocks, L[75010], R[75010], a[75010], pos[75010], cnt;
vector<pair<int, int> > OP;
vector<int> p[75010], ans;
vector<vector<int> > q[75010];
...
vector<vector<int> > Solve(vector<int> &V) {
  ...
  auto tmp = V;
  nth_element(tmp.begin(), tmp.begin() + (int)V.size() / 2, tmp.end(),
