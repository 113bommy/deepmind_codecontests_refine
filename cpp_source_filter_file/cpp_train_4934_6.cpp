...
int main() {
  ...
  c3 = min(min(a2, b2), c2);
  b3 = b2 + a2 + c2 - a3 - c3;
  if (ok(a1, b1, c1, a3, b3, c3) || ok(a1, b1, c1, a2, c2, b2) ||
      ok(a1, b1, c1, b2, a2, c2) || ok(a1, b1, c1, b2, c2, a2) ||
      ok(a1, b1, c1, c2, a2, b2) || ok(a1, b1, c1, c2, b2, a2))
    cout << "YES" << endl;
  else
    cout << "NO" << endl;
  return 0;
