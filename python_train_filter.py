...
python_json_path = './python_data/python_train.json'
...
def make_python_file(pid, index, code):
    with open(f'./python_file/python_train_{pid}_{index}.py', 'w') as f:
        f.write(code)
...
def compile_and_test(pid_index_codes):
    ...
    script_file_path = f"./python_file/python_train_{pid}_{index}.py"
...
def save_results(pid, results):
    try:
        with open(f'./python_train_result/python_train_check_{pid}.json', 'r+') as f:
        ...
        with open(f'./python_train_result/python_train_check_{pid}.json', 'w') as f:
