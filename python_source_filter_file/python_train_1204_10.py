...
for i in range(2,n+1):##start from two because i set all of them at one , so the first will start from the second and go till end, the second will start from the third till the end etc... 
