...
def compute_ways_2_eliminate_all_balls(ball_arrangement):
    ...
    if ball_segments_map[middle_ball_segment_pos][1] >= min_initial_length:
        ...
        # same color, if they exist at all
        remaining_segment_pairs = middle_ball_segment_index
        ...
        while remaining_segment_pairs > 0:
            # Move search outward
            left_segment_index -= 1
            right_segment_index -= 1

            # Obtain keys associated with surrounding segment pair
