...
if g == 1:
    ...
    if h==2:
        if '.' in a1[4:7] or '.' in a2[4:7] or '.' in a3[4:7]:
            a1 = a1[:5]+a1[4:7].replace('.', '!')+a1[7:]
            a2 = a2[:5]+a2[4:7].replace('.', '!')+a2[7:]
            a3 = a3[:5]+a3[4:7].replace('.', '!')+a3[7:]
        else:
            a1 = a1.replace('.', '!')
            a2 = a2.replace('.', '!')
            a3 = a3.replace('.', '!')
    ...
    if h == 2:
        if '.' in b4[4:7] or '.' in b5[4:7] or '.' in b6[4:7]:
            b4 = b4[:5]+b4[4:7].replace('.', '!')+b4[7:]
            b5 = b5[:5]+b5[4:7].replace('.', '!')+b5[7:]
            b6 = b6[:5]+b6[4:7].replace('.', '!')+b6[7:]
        else:
            a1 = a1.replace('.', '!')
            a2 = a2.replace('.', '!')
            a3 = a3.replace('.', '!')
    ...
    if h == 2:
        if '.' in c7[4:7] or '.' in c8[4:7] or '.' in c9[4:7]:
            c7 = c7[:5]+c7[4:7].replace('.', '!')+c7[7:]
            c8 = c8[:5]+c8[4:7].replace('.', '!')+c8[7:]
            c9 = c9[:5]+c9[4:7].replace('.', '!')+c9[7:]
        else:
            a1 = a1.replace('.', '!')
            a2 = a2.replace('.', '!')
            a3 = a3.replace('.', '!')
