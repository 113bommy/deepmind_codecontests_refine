...
cpp_test_result_path = os.path.join(curr_path, 'cpp_test_result')
cpp_valid_result_path = os.path.join(curr_path, 'cpp_valid_result')
cpp_train_result_path = os.path.join(curr_path, 'cpp_train_result')
