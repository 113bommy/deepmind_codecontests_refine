...
def make_python_file(pid, index, code):
    with open(f'./python_gold_filter_file/python_test_{pid}_{index}.py', 'w') as f:
        f.write(code)
...
def compile_and_test(pid_index_codes):
    ...
    script_file_path = f"./python_gold_filter_file/python_test_{pid}_{index}.py"
...
def save_results(pid, results):
    try:
        with open(f'./python_test_gold_result/python_test_check_{pid}.json', 'r+') as f:
        ...
        with open(f'./python_test_gold_result/python_test_check_{pid}.json', 'w') as f:
...
if __name__ == "__main__":
    delete_all_files_in_folder('./python_test_gold_result')
