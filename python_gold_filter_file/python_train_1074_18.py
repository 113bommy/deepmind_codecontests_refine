...
"""
"""
# Codeforces Round #212 (Div. 2), problem: (B) Petya and Staircases
...
"""
 # Codeforces Round #289 (Div. 2, ACM ICPC Rules), problem: (B) Painting Pebbles
# 4 4        
# 1 2 3 4
# Condition - |bi, c - bj, c| ≤ 1
# sol ->  1
#         1 1
#         1 1 2
#         1 1 3 4
...
"""
"""
 # Codeforces Round #281 (Div. 2), problem: (B) Vasya and Wrestling, 
n = int(input())
player1 = []
player2 = []
sum_1 = 0
...
#     sum_ = 0
#     for i in range(n):
#     	sum_ += math.floor((a*i+b)/m)
#     print(sum_) 

"""
# Codeforces Round #213 (Div. 2), problem: (B) The Fibonacci Segment
n = int(input())
arr = list(map(int, input().split()))
arr_2 = [2 for x in range(n)]
if n == 1:
    print(1)
else:
    ans = 2
