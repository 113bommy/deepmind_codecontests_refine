...
while d:
    search=d.pop()
    #print(search)
    searchlist=[(search[0]-1,search[1]-1),(search[0]-1,search[1]),(search[0]-1,search[1]+1),(search[0],search[1]-1),(search[0],search[1]+1),(search[0]+1,search[1]-1),(search[0]+1,search[1]),(search[0]+1,search[1]+1)]
