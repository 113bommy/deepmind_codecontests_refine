...
if n == 3:
    ...
    d = m - len(odds_in_odds) - len(evens_in_evens) + odds_in_odds_ + evens_in_evens_ - t1_odd_extra_changes - t1_even_extra_changes
    print(min(a, b, c, d))
    exit(0)
...
if m == 3:
    ...
    d = n - len(odds_in_odds) - len(evens_in_evens) + odds_in_odds_ + evens_in_evens_ - t1_odd_extra_changes - t1_even_extra_changes
    print(min(a, b, c, d))
    exit(0)
