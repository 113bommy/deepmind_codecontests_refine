...
int main() {
  ...
  while (t--) {
    ...
    if (b == 24) s = "abcdefghijklmnopqrstuvwx";
    if (b == 25) s = "abcdefghijklmnopqrstuvwxy";
    if (b == 26) s = "abcdefghijklmnopqrstuvwxyz";
    m = n % b;
    for (i = 1; i <= (n / b); i++) {
      cout << s;
    }
    if (m != 0) {
      ...
      if (m == 24) s = "abcdefghijklmnopqrstuvwx";
      if (m == 25) s = "abcdefghijklmnopqrstuvwxy";
      if (m == 26) s = "abcdefghijklmnopqrstuvwxyz";
      cout << s;
    }
    cout << endl;
    s.clear();
