#include <bits/stdc++.h>
const int limitN = 50;
using Array = double[limitN + 2][limitN + 2];
struct Matrix {
...
inline void printArray(const char *name, const Array a) {}
void dpProbability(const double p) {
  ...
  printArray("exact", exact);
  printArray("exactInit2", exactInit2);
}
void dpExpect() {
