...
python_test_result_path = os.path.join(curr_path, 'python_test_result')
python_valid_result_path = os.path.join(curr_path, 'python_valid_result')
python_train_result_path = os.path.join(curr_path, 'python_train_result')
