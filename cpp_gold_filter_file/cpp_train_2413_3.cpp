...
int32_t main() {
  ...
  for (auto i : s1) {
    if (i == *(s1.begin())) {
      ...
      long long int a3 =
          (abs(r - d) + i - ind + abs(r - r1) + abs(l1 - r1)) + v2[ind].second;
      long long int a4 = (abs(s1 - d) + i - ind + abs(s1 - r1) + abs(l1 - r1)) +
                         v2[ind].second;
      ...
      a3 = (abs(r - d) + i - ind + abs(r - l1) + abs(l1 - r1)) + v2[ind].second;
      a4 = (abs(s1 - d) + i - ind + abs(s1 - l1) + abs(l1 - r1)) +
           v2[ind].second;
