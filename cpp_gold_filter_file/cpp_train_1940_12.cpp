...
inline long long int dfs2(int lef, int rig) {
  ...
  for (int j = rig; j > lef; j--) {
    ...
    if (dp2[lef][rig] >= 4LL * 1000000007LL * 1000000007LL)
      dp2[lef][rig] -= 4LL * 1000000007LL * 1000000007LL;
  }
...
inline long long int dfs(int lef, int rig) {
  ...
  for (int j = rig; j >= lef; j--) {
    ...
    dp[lef][rig] += ans1;
    if (dp[lef][rig] >= 4LL * 1000000007LL * 1000000007LL)
      dp[lef][rig] -= 4LL * 1000000007LL * 1000000007LL;
  }
