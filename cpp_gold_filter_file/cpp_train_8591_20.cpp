  ...
  while (tt--) {
    ...
    for (int d : all) {
      ...
      do {
        ...
        if (*min_element(xx.begin(), xx.end()) ==
            *max_element(xx.begin(), xx.end())) {
          points.emplace_back(xx[0], (*max_element(yy.begin(), yy.end()) +
                                      *min_element(yy.begin(), yy.end())) /
                                         2);
        }
        if (*min_element(yy.begin(), yy.end()) ==
            *max_element(yy.begin(), yy.end())) {
          points.emplace_back((*max_element(xx.begin(), xx.end()) +
                               *min_element(xx.begin(), xx.end())) /
                                  2,
                              yy[0]);
        }
