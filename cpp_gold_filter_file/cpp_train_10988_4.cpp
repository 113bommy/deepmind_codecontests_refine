...
int main() {
  ...
  for (int i = (int)(6); i <= (int)(41); i++) add(i, i - 5, i, i - 4);
  for (int i = (int)(6); i <= (int)(41); i++) add(i - 5, i, i - 4, i);
  for (int i = (int)(6); i <= (int)(41); i++) add(i - 1, i - 5, i, i - 5);
  for (int i = (int)(6); i <= (int)(41); i++) add(i - 5, i - 1, i - 5, i);
  add(39, 40, 39, 41);
  add(40, 40, 40, 41);
  add(40, 39, 41, 39);
  add(40, 40, 41, 40);
