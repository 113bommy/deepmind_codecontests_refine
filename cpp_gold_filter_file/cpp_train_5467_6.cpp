#include <bits/stdc++.h>
using namespace std;
long long n, p, a[1000020], c[1000020], d[1000020], b[1000020], i, k, ans, xx,
    yy, xx1, yy1, kt, h, v, p1, p2, a1, pos1, pos2, pos3, rb, lb, mid, j,
    sa[1000020], sb[1000020], sd[1000020], sc[1000020], yy2, yy3, pc, m1, m2,
    m3, m4;
string t;
int main() {
  p = 1000000007;
