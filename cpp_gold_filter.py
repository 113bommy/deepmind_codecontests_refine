...
cpp_test_result_path = os.path.join(curr_path, 'cpp_test_gold_result')
cpp_valid_result_path = os.path.join(curr_path, 'cpp_valid_gold_result')
cpp_train_result_path = os.path.join(curr_path, 'cpp_train_gold_result')

cpp_test_refine_path = os.path.join(curr_path, 'cpp_data', 'cpp_test_refine.json')
cpp_valid_refine_path = os.path.join(curr_path, 'cpp_data', 'cpp_valid_refine.json')
cpp_train_refine_path = os.path.join(curr_path, 'cpp_data', 'cpp_train_refine.json')
